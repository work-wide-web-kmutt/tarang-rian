...
## Components
- MUST use accessible component primitives for keyboard or focus behavior
- MUST use existing project primitives first
...
## Typography
- MUST use text-balance for headings and text-pretty for body or paragraph text
...
- SHOULD use size-x for square elements instead of w-x and h-x
